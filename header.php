    ...
    <!--Header Part
      <div class="header-top container-cs">
        <div class="header-top-left">
          <ul>
            <li><i class="fa-solid fa-envelope"></i> <a href="mailto:abdullah.raian@info.com">info@quizwiz.com</a> </li>
      ...
      <hr>
      <!-- middle section -->
      <div class="header-middle container-cs">
        <div class="header-middle-logo">
          <a href="index.php"><img src="asset/img/QuizBee-logo.png" alt="logo"></a>
        </div>
